...
/// <summary>
/// Represents a collection of documents that can be organized and published together.
/// </summary>
public class Collection
{
    ...
    /// <summary>
    /// Gets or sets the status of the collection (e.g., Draft, Review, Published).
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets tags associated with the collection in JSON format.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets a value indicating whether the collection is deleted (soft delete).
    /// </summary>
    public bool IsDeleted { get; set; }

    /// <summary>
    /// Gets or sets the date and time when the collection was deleted.
    /// </summary>
    ...
    /// <summary>
    /// Navigation property for the documents in this collection.
    /// </summary>
